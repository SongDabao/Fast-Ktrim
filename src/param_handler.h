...
void usage( ) {
cerr << "\n\033[1;34mUsage: RabbitTrim [options] -1/-U Read1.fq [ -2 Read2.fq ] -o out.prefix\033[0m\n\n"
	 << "RabbitTrim Author : Honglei Song, Hao Zhang and Zekun Yin\n"
	 << "Ktrim Author : Kun Sun (sunkun@szbl.ac.cn)\n"
	 << "Ktrim Version: " << VERSION << "\n\n"

	 << "RabbitTrim is an enhanced version of Ktrim based on RabbitIO.\n\n"
	 ...
	 << "\033[1;34mRabbitTrim: enhanced extra-fast and accurate adapter- and quality-trimmer based on Ktrim.\033[0m\n\n";
}
